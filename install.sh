...
if [[ $9 == "" ]]
then
    mysql -u "$myuser" -e "CREATE DATABASE $1 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci"
else
    mysql -u "$myuser" -p"$9" -e "CREATE DATABASE $1 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci"
fi

mkdir wordpress && cd wordpress \
&& curl -O https://raw.githubusercontent.com/wp-cli/builds/gh-pages/phar/wp-cli.phar \
&& php wp-cli.phar core download --locale=$locale \
&& php wp-cli.phar config create --dbname=$1 --dbuser=root --dbpass="" --dbhost=127.0.0.1 --dbcharset=utf8mb4 --dbcollate=utf8mb4_unicode_ci \
